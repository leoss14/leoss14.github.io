# Copper production - Data package

This data package contains the data that powers the chart ["Copper production"](https://ourworldindata.org/explorers/minerals?Mineral=Copper&Metric=Production&Type=Mine&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
- Note on global production: World mine production is based on available country data published in the MR and the MYB and generally reflects the copper content of concentrates, precipitates, and electrowon copper. For some countries, including the United States, recoverable copper content is used. For other countries, such as Chile, data includes copper content of non-duplicative mine and metal products produced from domestic ores and concentrates. This data set was originally derived from the MR and the MYB, but data for 1940–85 may contain revisions to specific countries that reflect new understandings of production, especially for the former Soviet Union as reported by Strishkov (1984, p. 8).

Notes found in original USGS data:
- Production in 2020. Mine production in Russia is estimated in both years and refinery production in Canada is estimated in both years.
- Production in 2021.
- Production in 2022.
- Production in 2023.
