# Platinum group metals (palladium) reserves - Data package

This data package contains the data that powers the chart ["Platinum group metals (palladium) reserves"](https://ourworldindata.org/explorers/minerals?Mineral=Platinum+group+metals&Metric=Reserves&Type=Mine%2C+palladium&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
## Platinum group metals (palladium) reserves
...
#### Full citation
USGS - Mineral Commodity Summaries (2025) – with major processing by Our World in Data. “Platinum group metals (palladium) reserves” [dataset]. United States Geological Survey, “Mineral Commodity Summaries” [original data].
...
- Reserves for Russia are based on the Russian Classification system A+B+C1+C2, where C2 are deposits that are being developed or prepared for development.
