# Rare earths unit value - Data package

This data package contains the data that powers the chart ["Rare earths unit value"](https://ourworldindata.org/explorers/minerals?Mineral=Rare+earths&Metric=Unit+value&Type=Mine%2C+palladium&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
## Rare earths unit value
Value of 1 tonne of rare earths, in constant 1998 US$ per tonne.
Last updated: December 15, 2025  
Next update: December 2026  
Date range: 1961–2020  
...
#### Full citation
USGS - Historical Statistics for Mineral and Material Commodities (2024) – with major processing by Our World in Data. “Rare earths unit value” [dataset]. United States Geological Survey, “Historical Statistics for Mineral and Material Commodities” [original data].
...
### How is this data described by its producer - USGS - Historical Statistics for Mineral and Material Commodities (2024)?
Notes found in original USGS historical data:
- The Consumer Price Index conversion factor, with 1998 as the base year, is used to adjust unit value in current U.S. dollars to the unit value in constant 1998 U.S. dollars. Data were not available for 1900–21.
