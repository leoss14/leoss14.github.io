# Silver reserves - Data package

This data package contains the data that powers the chart ["Silver reserves"](https://ourworldindata.org/explorers/minerals?Mineral=Silver&Metric=Reserves&Type=Mine%2C+palladium&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
#### Full citation
USGS - Mineral Commodity Summaries (2025) – with major processing by Our World in Data. “Silver reserves” [dataset]. United States Geological Survey, “Mineral Commodity Summaries” [original data].
...
- For Australia, Joint Ore Reserves Committee-compliant or equivalent reserves were 27,000 tons. Revised based on Government reports.
- For Australia, Joint Ore Reserves Committee-compliant or equivalent reserves were 27,000 tons. Reserves for Australia, China, India, Peru, Poland, and Russia were revised based on Government reports.
- For Australia, Joint Ore Reserves Committee-compliant or equivalent reserves were 27,000 tons.
- Reserves for Australia, China, India, Peru, Poland, and Russia were revised based on Government reports.
- Reserves for Australia, China, India, Peru, Poland, and Russia were revised based on Government reports.  Revised March 5, 2024.
