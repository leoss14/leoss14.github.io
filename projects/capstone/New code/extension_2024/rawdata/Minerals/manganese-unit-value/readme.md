# Manganese unit value - Data package

This data package contains the data that powers the chart ["Manganese unit value"](https://ourworldindata.org/explorers/minerals?Mineral=Manganese&Metric=Unit+value&Type=Mine&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
## Manganese unit value
Value of 1 tonne of manganese, in constant 1998 US$ per tonne.
...
#### Full citation
USGS - Historical Statistics for Mineral and Material Commodities (2024) – with major processing by Our World in Data. “Manganese unit value” [dataset]. United States Geological Survey, “Historical Statistics for Mineral and Material Commodities” [original data].
...
- The Consumer Price Index, with 1998 as the base year, is used to adjust unit value in current dollars to the unit value in constant 1998 dollars.
