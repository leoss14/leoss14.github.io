# Silver production - Data package

This data package contains the data that powers the chart ["Silver production"](https://ourworldindata.org/explorers/minerals?Mineral=Silver&Metric=Production&Type=Mine%2C+palladium&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
- Note on global production: World production data for 1900 to the most recent year represent the recoverable silver content of precious-metal ores that were extracted from mines throughout the world. World production data were from the MR and the MYB.

Notes found in original USGS data:
- Production in 2020.
- Estimated in both years.
- Production in 2021. Estimated for Argentina and India.
- Production in 2022. Estimated for Argentina and India.
- Production in 2023.
- Estimated production in 2024.
-  Estimated in both years.

Notes found in original BGS data:
- Countries producing less than 1000 kg per year include Croatia, for the period 1993-95, and the Czech Republic and Finland in 1993 and 1994.
- Countries producing less than 1000 kg per year include Croatia, for the period 1994-95, and the Czech Republic and Finland in 1994.
- Countries producing less than 1000 kg per year include Ethiopia and the Republic of Korea, and Croatia and Oman in 1995.
- Countries producing less than 1000 kg per year include Ethiopia, Republic of Korea and Oman.
- Countries producing less than 1000 kg per year include the Republic of Korea and Oman.
- Countries producing less than 1000 kg per year include Jamaica, Oman and Thailand.
- Countries producing less than 1000 kg per year include Jamaica and Thailand.
