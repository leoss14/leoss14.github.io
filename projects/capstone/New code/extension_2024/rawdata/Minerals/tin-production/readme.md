# Tin production - Data package

This data package contains the data that powers the chart ["Tin production"](https://ourworldindata.org/explorers/minerals?Mineral=Tin&Metric=Production&Type=Mine&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
- Note on global production: World production data were for tin content of mine and mill production. Data were from the MYB and MR. Data were not available for 1900–04.

Notes found in original USGS data:
- Production in 2020, metric tons contained tin. Data are estimated for Burma, China, Congo (Kinshasa), Indonesia, Laos, Nigeria, Rwanda, and Vietnam.
- Production in 2021, metric tons contained tin. Data are estimated for Burma, China, Congo (Kinshasa), Indonesia, Laos, Nigeria, Rwanda, and Vietnam.
- Production in 2023.
...
- The figures in this table include artisanal mining, where data are available.
...
- Estimates based on reported exports.
- Metal.
