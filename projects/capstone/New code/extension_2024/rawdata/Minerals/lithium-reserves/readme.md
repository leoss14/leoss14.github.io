# Lithium reserves - Data package

This data package contains the data that powers the chart ["Lithium reserves"](https://ourworldindata.org/explorers/minerals?Mineral=Lithium&Metric=Reserves&Type=Mine&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
#### Full citation
USGS - Mineral Commodity Summaries (2025) – with major processing by Our World in Data. “Lithium reserves” [dataset]. United States Geological Survey, “Mineral Commodity Summaries” [original data].
...
- Reserves for Argentina, Australia, Brazil, China, the United States, and “Other countries” were revised based on company and Government reports.
- Reserves of the mineral commodity in the subject country.
- Revised based on information from Government and industry sources. For Australia, Joint Ore Reserves Committee-compliant or equivalent reserves were 3.8 million tons.
- For Australia, Joint Ore Reserves Committee-compliant or equivalent reserves were 4.8 million tons. Reserves for Argentina, Australia, Brazil, China, the United States, and “Other countries” were revised based on company and Government reports.
- For Australia, Joint Ore Reserves Committee-compliant or equivalent reserves were 4.8 million tons.
- Other countries with reported reserves: Austria, Congo (Kinshasa), Czechia, Finland, Germany, Ghana, Mali, Mexico, Namibia, Serbia, and Spain. Revised based on information from Government and industry sources.
- Other countries with reported reserves include Austria, Congo (Kinshasa), Czechia, Finland, Germany, Ghana, Mali, Mexico, Serbia, and Spain.
