# Aluminum unit value - Data package

This data package contains the data that powers the chart ["Aluminum unit value"](https://ourworldindata.org/explorers/minerals?Mineral=Aluminum&Metric=Unit+value&Type=Mine&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
## Aluminum unit value
Value of 1 tonne of aluminum, in constant 1998 US$ per tonne.
...
#### Full citation
USGS - Historical Statistics for Mineral and Material Commodities (2024) – with major processing by Our World in Data. “Aluminum unit value” [dataset]. United States Geological Survey, “Historical Statistics for Mineral and Material Commodities” [original data].
