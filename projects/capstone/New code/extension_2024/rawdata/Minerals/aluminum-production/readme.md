# Aluminum production - Data package

This data package contains the data that powers the chart ["Aluminum production"](https://ourworldindata.org/explorers/minerals?Mineral=Aluminum&Metric=Production&Type=Mine&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
## Aluminum production
Measured in tonnes. [Smelting](#dod:smelting) takes raw minerals and produces metals through high-temperature processes.
...
- Note on global production: Data are defined as world primary aluminum production. Data are reported in the MR and MYB.

Notes found in original USGS data:
- Production and yearend capacity in 2020.
- Production and yearend capacity in 2021.
- Production and yearend capacity in 2022.
- Production in 2023.
- Estimated production in 2024.
- Estimated 2023.
- Production in 2021 is also estimated.
- Production in 2022 is also estimated.

Notes found in original BGS data:
- The figures in this table are for primary aluminium only. Aluminium can also be produced from secondary sources and may be recovered from salt slags.
