# Zinc reserves - Data package

This data package contains the data that powers the chart ["Zinc reserves"](https://ourworldindata.org/explorers/minerals?Mineral=Zinc&Metric=Reserves&Type=Mine&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
#### Full citation
USGS - Mineral Commodity Summaries (2025) – with major processing by Our World in Data. “Zinc reserves” [dataset]. United States Geological Survey, “Mineral Commodity Summaries” [original data].
