...
This data package contains the data that powers the chart ["Coal production"](https://ourworldindata.org/explorers/minerals?Mineral=Coal&Metric=Production&Type=Mine&Share+of+global=false&country=OWID_WRL~AUS~CHL~CHN~USA) on the Our World in Data website. It was downloaded on January 08, 2026.
...
#### Full citation
BGS - World Mineral Statistics (2025) – with major processing by Our World in Data. “Coal production” [dataset]. British Geological Survey, “World Mineral Statistics” [original data].
